        ...
        return (
            <div className='content'>
                ...
                <div>
                    ...
                    <div className='mdc-typography--display1'>Information Collection, Use, and Sharing</div>
                    ...
                    <div className='mdc-typography--display1'>Your Access to and Control Over Information</div>
                    ...
                    <div className='mdc-typography--display1'>Security</div>
                    ...
                    <div className='mdc-typography--display1'>Registration</div>
                    ...
                    <div className='mdc-typography--display1'>Cookies</div>
                    ...
                    <div className='mdc-typography--display1'>Links</div>
                    <p>This website contains links to other sites. Please be aware that we are not responsible for the content or privacy practices of such other sites. We encourage our users to be aware when they leave our site and to read the privacy statements of any other site that collects personally identifiable information.</p>

                    <p><b>If you feel that we are not abiding by this privacy policy, you should contact us immediately via <a href="mailto:jake.kinsella@gmail.com">email</a>.</b></p>
                </div>
