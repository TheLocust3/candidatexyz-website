...
class Privacy extends React.Component {
    ...
    render() {
        return (
            <div className='content mdc-typography--body1'>
                <h1 className='mdc-typography--headline4'>Privacy Policy</h1>
                ...
                <div>
                    ...
                    <div className='mdc-typography--headline5'>Information Collection, Use, and Sharing</div>
                    ...
                    <div className='mdc-typography--headline5'>Your Access to and Control Over Information</div>
                    ...
                    <div className='mdc-typography--headline5'>Security</div>
                    ...
                    <div className='mdc-typography--headline5'>Registration</div>
                    ...
                    <div className='mdc-typography--headline5'>Cookies</div>
                    ...
                    <div className='mdc-typography--headline5'>Links</div>
