    ...
    render() {
        return (
            <div className='content'>
                ...
                <div>
                    This privacy notice discloses the privacy practices for <Link to='/'>www.candidatexyz.com</Link>. This privacy notice applies solely to information collected by this website.<br /><br />

                    <div className='mdc-typography--headline'>Information Collection, Use, and Sharing</div>
                    ...
                    <div className='mdc-typography--headline'>Your Access to and Control Over Information</div>
                    You may opt out of any future contacts from us at any time. You can do the following at any time by contacting us via the email address given on our website:<br /><br />
                    ...
                    <div className='mdc-typography--headline'>Security</div>
                    ...
                    <div className='mdc-typography--headline'>Registration</div>
                    In order to use this website, a user must first complete the registration form. During registration a user is required to give certain information (such as name and email address). This information is used to contact you about the products/services on our site in which you have expressed interest. At your option, you may also provide demographic information (such as gender or age) about yourself, but it is not required.<br /><br />

                    <div className='mdc-typography--headline'>Cookies</div>
                    ...
                    <div className='mdc-typography--headline'>Links</div>
                    This website contains links to other sites. Please be aware that we are not responsible for the content or privacy practices of such other sites. We encourage our users to be aware when they leave our site and to read the privacy statements of any other site that collects personally identifiable information.<br /><br />

                    <b>If you feel that we are not abiding by this privacy policy, you should contact us immediately via <a href="mailto:jake.kinsella@gmail.com">email</a>.</b>
                </div>
